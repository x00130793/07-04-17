...
//	return ok(register.render());
   // }
    ...
    @Transactional
    public Result updateUser(Long cat, String filter){
        
        User u = getUserFromSession();
        Form<User> userForm = Form.form(User.class).fill(u);
        return redirect(controllers.routes.CustomerCtrl.payment(cat, filters));
    }
