...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """updateUser""", """controllers.HomeController.updateUser(cat:Long ?= 0, filter:String ?= "")"""),
  ...
  // @LINE:31
  private[this] lazy val controllers_HomeController_updateUser16_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateUser")))
  )
  private[this] lazy val controllers_HomeController_updateUser16_invoker = createInvoker(
    HomeController_2.updateUser(fakeValue[Long], fakeValue[String]),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "updateUser",
  ...
  // @LINE:32
  private[this] lazy val controllers_CustomerCtrl_payment17_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("payment")))
  )
  private[this] lazy val controllers_CustomerCtrl_payment17_invoker = createInvoker(
...
###############""",
  ...
  // @LINE:59
  private[this] lazy val controllers_HomeController_addUserSubmit27_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addUserSubmit")))
  )
  private[this] lazy val controllers_HomeController_addUserSubmit27_invoker = createInvoker(
  ...
  // @LINE:63
  private[this] lazy val controllers_CountController_count28_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("count")))
  )
  private[this] lazy val controllers_CountController_count28_invoker = createInvoker(
  ...
  // @LINE:65
  private[this] lazy val controllers_AsyncController_message29_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("message")))
  )
  private[this] lazy val controllers_AsyncController_message29_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:31
    case controllers_HomeController_updateUser16_route(params) =>
      call(params.fromQuery[Long]("cat", Some(0)), params.fromQuery[String]("filter", Some(""))) { (cat, filter) =>
        controllers_HomeController_updateUser16_invoker.call(HomeController_2.updateUser(cat, filter))
      }
  
    // @LINE:32
    case controllers_CustomerCtrl_payment17_route(params) =>
      call(params.fromQuery[Long]("cat", Some(0)), params.fromQuery[String]("filter", Some(""))) { (cat, filter) =>
        controllers_CustomerCtrl_payment17_invoker.call(CustomerCtrl_5.payment(cat, filter))
      }
    ...
    // @LINE:56
    case controllers_LoginController_login24_route(params) =>
      call(params.fromQuery[Long]("cat", Some(0)), params.fromQuery[String]("filter", Some(""))) { (cat, filter) =>
        controllers_LoginController_login24_invoker.call(LoginController_7.login(cat, filter))
      }
  
    // @LINE:57
    case controllers_LoginController_loginSubmit25_route(params) =>
      call(params.fromQuery[Long]("cat", Some(0)), params.fromQuery[String]("filter", Some(""))) { (cat, filter) =>
        controllers_LoginController_loginSubmit25_invoker.call(LoginController_7.loginSubmit(cat, filter))
      }
  
    // @LINE:58
    case controllers_LoginController_logout26_route(params) =>
      call(params.fromQuery[Long]("cat", Some(0)), params.fromQuery[String]("filter", Some(""))) { (cat, filter) =>
        controllers_LoginController_logout26_invoker.call(LoginController_7.logout(cat, filter))
      }
  
    // @LINE:59
    case controllers_HomeController_addUserSubmit27_route(params) =>
      call(params.fromQuery[Long]("cat", Some(0)), params.fromQuery[String]("filter", Some(""))) { (cat, filter) =>
        controllers_HomeController_addUserSubmit27_invoker.call(HomeController_2.addUserSubmit(cat, filter))
      }
  
    // @LINE:63
    case controllers_CountController_count28_route(params) =>
      call { 
        controllers_CountController_count28_invoker.call(CountController_1.count)
      }
  
    // @LINE:65
    case controllers_AsyncController_message29_route(params) =>
      call { 
        controllers_AsyncController_message29_invoker.call(AsyncController_3.message)
      }
  
    // @LINE:68
    case controllers_Assets_versioned30_route(params) =>
      call(Param[String]("path", Right("/public")), params.fromPath[Asset]("file", None)) { (path, file) =>
        controllers_Assets_versioned30_invoker.call(Assets_6.versioned(path, file))
      }
  }
}
